...
import { 
  ...
  const Topbar = ({ toggleSidebar, isSidebarOpen, isCollapsed }) => {
    return (
      <header 
        className={`
          fixed 
          ...
          lg:${isCollapsed ? 'right-20' : 'right-64'}
        `}
        style={{
          // Smart positioning based on sidebar state
          right: window.innerWidth >= 1024 
            ? (isCollapsed ? '80px' : '256px')  // Desktop: adjusts to sidebar
            : '0px'                               // Mobile: full width
        }}
        dir="rtl"
      >
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="lg:hidden w-9 h-9 bg-slate-800 text-white rounded-lg flex items-center justify-center hover:bg-slate-700 transition-colors"
