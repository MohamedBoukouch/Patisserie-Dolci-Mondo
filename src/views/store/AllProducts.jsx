...
const AllProducts = () => {
  ...
  useEffect(() => {
    ...
    const timers = result.map((_, index) =>
      setTimeout(() => {
        setItemsVisible(prev => {
          const newArr = [...prev];
          newArr[index] = true;
  ...
  return (
    <section className="w-full py-12 md:py-20 px-4 md:px-6 bg-white">
      ...
      {/* ── Filter Bar — dynamic from categories.js ── */}
        ...
        <div className="flex flex-wrap justify-center gap-2 md:gap-3 max-w-4xl">
          {categories.map((cat) => (
            <button
              ...
              className={`px-4 py-2 md:px-5 md:py-2.5 text-xs md:text-sm font-light
          ...
          {filteredProducts.map((prod, index) => (
            ...
            >
              ...
              <div className="relative w-full aspect-square overflow-hidden bg-white">
                ...
                {/* WhatsApp — slides up on hover, all screens */}
                <div
